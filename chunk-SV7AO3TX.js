...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-PE3HVNAA.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-AI4XOJM4.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-KKMWOE4N.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-OSENBOV3.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-PSG4JN7T.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-M2XUPKPG.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-7EOYILOF.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-L2ODZFQR.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-RO5D3XYB.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-YXGB52CF.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-R6TOIW64.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-SWOTR5DD.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "0e30fea";
        const gitBranch = "dev";
        const buildTime = "2026-04-28T03:40:48.895Z";

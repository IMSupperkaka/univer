...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-HDJPKHJY.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-A3OL6BEH.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-3AKNCEDX.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-6THDFN6B.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-LQJMF2PH.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-JLZDLOLJ.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-SGRVI4EG.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-VLSQTHDT.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-LXPMZBD5.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-5UF2IIF2.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-RZ2BGFIM.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-C6MILB7R.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "0bcc094";
        const gitBranch = "dev";
        const buildTime = "2026-05-23T12:06:42.108Z";

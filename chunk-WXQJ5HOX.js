...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-L6OQDEVI.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-6TSV7BNP.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-ZIETKSXN.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-2F2MSQ7X.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-F2YAKJSS.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-GZV4IZ2B.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-EAC75NHO.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-RN4XVEUW.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-EOIHAFEK.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-F4OSS42X.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-YR5ES4CN.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-ZB2GX4RB.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "2720250";
        const gitBranch = "dev";
        const buildTime = "2026-05-16T12:13:48.742Z";
